...
if (isset($_POST['submit'])) {
    $pg_insert = " INSERT INTO `pzp_pg_details` (`owner_mail`,`pg_name`,`address1`,`address2`,`pgtype`,`wifi`,`food`,`pg_category`,`image`) VALUES ('$ownermail','$pg_name','$addrs1','$addrs2','$pgtype','$wifi','$food','$pgcate','$pgphoto'); ";
